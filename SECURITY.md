...
Thank you for helping us keep BCIP Agent secure!
...
## How to operate BCIP Agent safely

For details on BCIP Agent security boundaries, including sandboxing, approvals, and network controls, see [Agent approvals & security](https://developers.openai.com/codex/agent-approvals-security).
