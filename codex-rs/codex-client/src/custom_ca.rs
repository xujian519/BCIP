...
/// Builds a reqwest client that honors BCIP custom CA environment variables.
///
...
/// Builds a rustls client config when a BCIP custom CA bundle is configured.
///
...
fn maybe_build_rustls_client_config_with_env(
    ...
    // they would get from tungstenite's default rustls connector, then layer in the BCIP custom
