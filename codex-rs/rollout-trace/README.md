...
during a BCIP session. It records raw runtime evidence into a local bundle on
...
BCIP session fail just because diagnostic recording failed. Core emits raw
...
BCIP rollout/session being observed. Keeping those separate lets us reason about
