...
- a `codex-linux-sandbox` standalone executable for Linux that is bundled with the Node.js version of the BCIP Agent
...
**Notes**
- The CLI surface is `bcip sandbox`; the host OS selects the sandbox backend.
