...
#[derive(Debug, Parser)]
#[command(
    bin_name = "bcip plugin add",
    after_help = "Examples:\n  bcip plugin add sample@debug\n  bcip plugin add sample --marketplace debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "bcip plugin list",
    after_help = "Examples:\n  bcip plugin list\n  bcip plugin list --marketplace debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "bcip plugin remove",
    after_help = "Examples:\n  bcip plugin remove sample@debug\n  bcip plugin remove sample --marketplace debug"
)]
