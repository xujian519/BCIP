...
const GITHUB_LATEST_RELEASE_URL: &str =
    "https://api.github.com/repos/xujian519/BCIP/releases/latest";
const HOMEBREW_CASK_API_URL: &str = "https://formulae.brew.sh/api/cask/bcip-agent.json";
...
fn update_action_label(context: &InstallContext) -> &'static str {
    match &context.method {
        InstallMethod::Npm => "npm install -g @xujian519/bcip-agent",
        InstallMethod::Bun => "bun install -g @xujian519/bcip-agent",
        InstallMethod::Brew => "brew upgrade --cask bcip-agent",
