...
# Run a suite of smoke tests against the Windows sandbox via the BCIP Agent
...
def _resolve_codex_cmd() -> List[str]:
    """Resolve the BCIP Agent to invoke `codex sandbox windows`.
    ...
    raise FileNotFoundError(
        "BCIP Agent not found. Build it first, e.g.\n"
