...
const SESSION_NAME: &str = "BCIP Windows Sandbox WFP";
const PROVIDER_NAME: &str = "BCIP Windows Sandbox WFP";
const PROVIDER_DESCRIPTION: &str = "Persistent WFP provider for Codex Windows sandbox filters";
const SUBLAYER_NAME: &str = "BCIP Windows Sandbox WFP";
...
/// Ensures the persistent BCIP sublayer exists under the BCIP provider.
