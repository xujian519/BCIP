...
/// The high-level interface to the BCIP system.
...
impl Codex {
    ...
    async fn spawn_internal(args: CodexSpawnArgs) -> CodexResult<CodexSpawnOk> {
        ...
        // Generate a unique ID for the lifetime of this BCIP session.
    ...
    /// Use sparingly: prefer `submit()` so BCIP is responsible for generating
