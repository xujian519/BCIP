...
mod tests {
    ...
    fn canonicalize_git_remote_url_normalizes_github_variants() {
        for remote in [
            "git@github.com:xujian519/BCIP.git",
            "ssh://git@github.com/xujian519/BCIP.git",
            "ssh://git@github.com:22/xujian519/BCIP.git",
            "https://github.com/xujian519/BCIP.git",
            "https://github.com:443/xujian519/BCIP.git",
            "https://token@github.com/xujian519/BCIP/",
            "github.com/xujian519/BCIP.git",
        ] {
            assert_eq!(
                canonicalize_git_remote_url(remote),
                Some("github.com/xujian519/BCIP".to_string())
            );
        }
    }
    ...
    fn canonicalize_git_remote_url_rejects_non_repository_values() {
        for remote in ["", "file:///tmp/repo", "github.com/xujian519", "/tmp/repo"] {
