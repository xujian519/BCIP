...
impl TestToolServer {
    ...
    /// Tool intended for manual testing of BCIP TUI rendering for MCP image tool results.
    ///
    ...
    ///
    /// Manual testing approach (BCIP TUI):
    ...
    /// - Then in BCIP TUI, ask it to call:
    ...
    fn memo_template() -> ResourceTemplate {
        let raw = RawResourceTemplate {
            ...
            title: Some("BCIP Memo".to_string()),
            description: Some(
...
/// Scenarios for `image_scenario`, intended to exercise BCIP TUI handling of MCP image outputs.
///
