...
const BASE_CLI_BUG_ISSUE_URL: &str =
    "https://github.com/xujian519/BCIP/issues/new?template=3-cli.yml";
...
pub(crate) fn feedback_upload_consent_params(
    ...
    let mut header_lines: Vec<Box<dyn crate::render::renderable::Renderable>> = vec![
        ...
        Line::from(vec!["  • ".into(), "bcip-logs.log".into()]).into(),
        Line::from(vec![
            "  • ".into(),
    ...
    super::SelectionViewParams {
        ...
        items: vec![
            super::SelectionItem {
                name: "Yes".to_string(),
                description: Some(
                    "Share the current BCIP session logs and diagnostics with the team for troubleshooting."
                        .to_string(),
                ),
...
mod tests {
    ...
    fn issue_url_available_for_bug_bad_result_safety_check_and_other() {
        ...
        let expected_external_url = "https://github.com/xujian519/BCIP/issues/new?template=3-cli.yml&steps=Uploaded%20thread:%20t";
