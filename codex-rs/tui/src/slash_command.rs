...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Init => "create an AGENTS.md file with instructions for BCIP",
            ...
            SlashCommand::Quit | SlashCommand::Exit => "exit BCIP",
            SlashCommand::Copy => "copy last response as markdown",
            SlashCommand::Raw => "toggle raw scrollback mode for copy-friendly terminal selection",
            SlashCommand::Diff => "show git diff (including untracked files)",
            SlashCommand::Mention => "mention a file",
            SlashCommand::Skills => "use skills to improve how BCIP performs specific tasks",
            ...
            SlashCommand::Personality => "choose a communication style for BCIP",
            ...
            SlashCommand::Permissions => "choose what BCIP is allowed to do",
            ...
            SlashCommand::Logout => "log out of BCIP",
