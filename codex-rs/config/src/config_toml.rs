...
pub struct ConfigToml {
    ...
    /// sanctioned by BCIP will likely degrade model performance.
    ...
    /// file: Use a file in the BCIP home directory.
    ...
    /// Directory where BCIP writes log files. Setting this value explicitly
    ...
    /// Optional product SKU forwarded on host-owned BCIP Apps MCP requests.
...
pub struct DebugConfigLockToml {
    ...
    /// Allow replaying a lock generated by a different BCIP version.
