#!/usr/bin/env python3
"""Stage and optionally package the @xujian519/bcip-agent npm module."""
...
CODEX_NPM_NAME = "@xujian519/bcip-agent"
CODEX_PACKAGE_COMPONENT = "codex-package"

# `npm_name` is the local optional-dependency alias consumed by `bin/codex.js`.
# The underlying package published to npm is always `@xujian519/bcip-agent`.
CODEX_PLATFORM_PACKAGES: dict[str, dict[str, str]] = {
    "codex-linux-x64": {
        "npm_name": "@xujian519/bcip-agent-linux-x64",
        "npm_tag": "linux-x64",
    ...
    "codex-linux-arm64": {
        "npm_name": "@xujian519/bcip-agent-linux-arm64",
        "npm_tag": "linux-arm64",
    ...
    "codex-darwin-x64": {
        "npm_name": "@xujian519/bcip-agent-darwin-x64",
        "npm_tag": "darwin-x64",
    ...
    "codex-darwin-arm64": {
        "npm_name": "@xujian519/bcip-agent-darwin-arm64",
    ...
    "codex-win32-x64": {
        "npm_name": "@xujian519/bcip-agent-win32-x64",
        "npm_tag": "win32-x64",
    ...
    "codex-win32-arm64": {
        "npm_name": "@xujian519/bcip-agent-win32-arm64",
        "npm_tag": "win32-arm64",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build or stage the BCIP Agent CLI npm package.")
    parser.add_argument(
        "--package",
