...
def pinned_runtime_codex_path() -> Path:
    ...
    if not codex_path.exists():
        raise RuntimeError(f"Pinned BCIP runtime binary not found at {codex_path}.")
    return codex_path
...
def build_parser() -> argparse.ArgumentParser:
    ...
    stage_sdk_parser.add_argument(
        "--codex-version",
        help=(
            "BCIP release version to write into the staged SDK package and exact "
    ...
    stage_runtime_parser.add_argument(
        "--codex-version",
        help=(
            "BCIP release version to write into the staged runtime package. "
